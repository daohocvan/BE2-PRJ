        ...
        <div class="footer-top">
          <div class="wrap">
            ...
            <div class="col_1_of_2 span_1_of_2">
              <ul class="f-list">
                <li><img src=""><span class="f-text">Free Shipping on orders over $ 100</span><div class="clear"></div></li>
              </ul>
            </div>
            <div class="col_1_of_2 span_1_of_2">
              <ul class="f-list">
                <li><img src=""><span class="f-text">Call us! toll free-0963 416 058 </span><div class="clear"></div></li>
              </ul>
            </div>
            <div class="clear"></div>
              </div>
              ...
              <div class="section group example">
                <div class="col_1_of_f_1 span_1_of_f_1">
                  <div class="section group example">
                    ...
                    <div class="col_1_of_f_2 span_1_of_f_2" style="padding-left: 30px">
                      <h3>Account</h3>
                      <ul class="f-list1">
                  ...
                  <div class="section group example">
                    ...
                    <div class="col_1_of_f_2 span_1_of_f_2">
                      ...
                      <div class="company_address">
                        ...
                        <p>Fax:39 39 39 39</p>
                        <p>Email: <span>leoshop.com</span></p>
                      </div>
